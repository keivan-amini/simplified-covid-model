# Sociality vs Mobility code, 2020-2022.
...
# Function that take in input 3 strings and outputs one single mobility array.

def get_total_mobility(url):

    '''
    Given the link of the mobility dataframe, return the mobility.
